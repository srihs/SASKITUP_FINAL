...
from .models import Club, ClubCategory, Product, ProductVariation
...
class ProductAdmin(admin.ModelAdmin):
    ...
    """
    list_display = [
        'name', 'category', 'club_name', 'price', 'stock_status', 
        'sku', 'is_on_sale', 'has_variations_display', 'woo_product_id', 'created_at'
    ]
    list_filter = [
        'stock_status', 'category__club__club_type', 'category__club', 
        'category', 'created_at'
    ]
    search_fields = [
...
class ProductVariationAdmin(admin.ModelAdmin):
    ...
    list_filter = [
        'variation_type', 'is_active', 'product__category__club__club_type',
        'product__category__club', 'product__category', 'created_at'
    ]
    search_fields = [
